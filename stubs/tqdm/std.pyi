...
class tqdm(Comparable):
    ...
    @classmethod
    def external_write_mode(cls, file: Any | None = ..., nolock: bool = ...) -> Generator[None, None, None]: ...
    @classmethod
    ...
    @classmethod
    def wrapattr(cls, stream, method, total: Any | None = ..., bytes: bool = ..., **tqdm_kwargs) -> Generator[Any, None, None]: ...
